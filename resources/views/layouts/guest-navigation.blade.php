        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="flex items-center border-b-2 border-indigo-500 shrink-0">
                    <a href="{{ route('home') }}" class="font-bold sm:hidden dark:text-gray-200">Rental<span
                            class="text-indigo-500">Mobil</span></a>
                </div>
                <!-- Navigation Links -->
                <div class="hidden gap-4 sm:-my-px sm:flex">
                    <x-nav-link :href="route('home')" class="hidden font-bold md:flex dark:text-gray-200">
                        Rental<span class="text-indigo-500">Mobil</span>
                    </x-nav-link>
            ...
            <div class="flex">
                @guest
                    <div class="h-10 mt-3 sm:flex sm:ml-2 ">
                        <x-modes />
                    </div>
